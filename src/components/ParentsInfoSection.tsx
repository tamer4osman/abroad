...
import { DateField, EmailField } from "../components/common";
  ...
  <Section title="معلومات الوالدين">
    ...
    <div className="grid grid-cols-3 gap-4 mt-4">
      <FormField
        ...
        type="text"
      />
        <EmailField label="عنوان البريد الإلكتروني" id="motherEmail" name="motherEmail" value={parentsInfo.motherEmail} />
       <FormField
        label="رقم الهاتف"
