...
const MarriageRegistration = lazy(
  () => import("./components/MarriageRegistration")
);
const BirthRegistration = lazy(() => import("./components/BirthRegistration"));
const DivorceRegistration = lazy(
  () => import("./components/DivorceRegistration")
);
...
const CompletedRequestsPassports = lazy(
  () => import("./components/CompletedRequestsPassports")
);
const NewRequestVisas = lazy(() => import("./components/NewRequestVisas"));
const PendingRequestsVisas = lazy(
  () => import("./components/PendingRequestsVisas")
);
const CompletedRequestsVisas = lazy(
  () => import("./components/CompletedRequestsVisas")
);
const LocalAttestation = lazy(() => import("./components/LocalAttestation"));
const InternationalAttestation = lazy(
  () => import("./components/InternationalAttestation")
);
...
const DocumentCompletionProxy = lazy(
  () => import("./components/DocumentCompletionProxy")
);
...
const Topbar = memo<TopbarProps>(
  ({ theme, toggleTheme, isSidebarOpen, setIsSidebarOpen }) => (
...
const Sidebar = memo<SidebarProps>(
  ({ isSidebarOpen, setIsSidebarOpen, sidebarItems }) => {
          ...
          <div className="flex-1 overflow-y-auto">
            <Suspense fallback={<div>Loading...</div>}>
              <Routes>
                ...
                <Route
                  path="/passports/add-child"
                  element={<AddChildToPassport />}
                />
                <Route
                  path="/passports/completed-requests"
                  element={<CompletedRequestsPassports />}
                />
                <Route
                  path="/visas/new-request"
                  element={<NewRequestVisas />}
                />
                <Route
                  path="/visas/pending-requests"
                  element={<PendingRequestsVisas />}
                />
                <Route
                  path="/visas/completed-requests"
                  element={<CompletedRequestsVisas />}
                />
                <Route
                  path="/attestations/local"
                  element={<LocalAttestation />}
                />
                <Route
                  path="/attestations/international"
                  element={<InternationalAttestation />}
                />
                ...
                <Route
                  path="/proxies/real-estate"
                  element={<RealEstateProxy />}
                />
                <Route
                  path="/proxies/inheritance"
                  element={<InheritanceProxy />}
                />
                <Route
                  path="/proxies/document-completion"
                  element={<DocumentCompletionProxy />}
                />
